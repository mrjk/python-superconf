...
assert len(o_resources.get_value()) == RESOURCES_COUNT
...
assert o_laptop.get_value() == RESOURCES1["laptop"]
...
assert o_wifi.get_value() is not RESOURCES1["wifi-ap"]
# pprint(o_wifi.get_value())
# pprint(RESOURCES1["wifi-ap"])
assert o_wifi.get_value()["location"] == RESOURCES1["wifi-ap"]["location"]  # TOFIX
assert o_wifi.get_value()["owner"] == "MISSING OWNER"  # TOFIX
